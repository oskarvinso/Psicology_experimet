...
Sub Mostrar_Test6()
    If Pos = 1 Then
        ...
        Comp_Test6(1).Picture = LoadPicture(App.Path & "\data\img\cuadrado.jpg")
    ...
    Else
        ...
        Comp_Test6(0).Picture = LoadPicture(App.Path & "\data\img\cuadrado.jpg")
        Comp_Test6(0).Visible = True
        Component_2Pos(0) = "cuadrado"
    End If
End Sub
...
Sub Mostrar_Test7()
    If Pos = 1 Then
        Comp_Test7(0).Picture = LoadPicture(App.Path & "\data\img\circulo.jpg")
        Comp_Test7(0).Visible = True
        Component_2Pos(0) = "circulo"

        Comp_Test7(1).Picture = LoadPicture(App.Path & "\data\img\triangulo.jpg")
        Comp_Test7(1).Visible = True
        Component_2Pos(1) = "triangulo"
    Else
        Comp_Test7(1).Picture = LoadPicture(App.Path & "\data\img\circulo.jpg")
        Comp_Test7(1).Visible = True
        Component_2Pos(1) = "circulo"

        Comp_Test7(0).Picture = LoadPicture(App.Path & "\data\img\triangulo.jpg")
        Comp_Test7(0).Visible = True
        Component_2Pos(0) = "triangulo"
    End If
End Sub
...
Sub Mostrar_Test8()
    If Pos = 1 Then
        Comp_Test8(0).Picture = LoadPicture(App.Path & "\data\img\circulo.jpg")
        Comp_Test8(0).Visible = True
        Component_2Pos(0) = "circulo"

        Comp_Test8(1).Picture = LoadPicture(App.Path & "\data\img\rojo.jpg")
        Comp_Test8(1).Visible = True
        Component_2Pos(1) = "rojo"
    Else
        Comp_Test8(1).Picture = LoadPicture(App.Path & "\data\img\circulo.jpg")
        Comp_Test8(1).Visible = True
        Component_2Pos(1) = "circulo"

        Comp_Test8(0).Picture = LoadPicture(App.Path & "\data\img\rojo.jpg")
        Comp_Test8(0).Visible = True
        Component_2Pos(0) = "rojo"
    End If
End Sub
Sub Mostrar_Test9()
    If Pos = 1 Then
        Comp_Test9(0).Picture = LoadPicture(App.Path & "\data\img\circulo.jpg")
        Comp_Test9(0).Visible = True
        Component_2Pos(0) = "circulo"

        Comp_Test9(1).Picture = LoadPicture(App.Path & "\data\img\verde.jpg")
        Comp_Test9(1).Visible = True
        Component_2Pos(1) = "verde"
    Else
        Comp_Test9(1).Picture = LoadPicture(App.Path & "\data\img\circulo.jpg")
        Comp_Test9(1).Visible = True
        Component_2Pos(1) = "circulo"

        Comp_Test9(0).Picture = LoadPicture(App.Path & "\data\img\verde.jpg")
        Comp_Test9(0).Visible = True
        Component_2Pos(0) = "verde"
    End If
End Sub
...
Sub Mostrar_Test10()
    If Pos = 1 Then
        Comp_Test10(0).Picture = LoadPicture(App.Path & "\data\img\triangulo_verde.jpg")
        Comp_Test10(0).Visible = True
        Component_2Pos(0) = "triangulo_verde"

        Comp_Test10(1).Picture = LoadPicture(App.Path & "\data\img\cuadrado_rojo.jpg")
        Comp_Test10(1).Visible = True
        Component_2Pos(1) = "cuadrado_rojo"
    Else
        Comp_Test10(1).Picture = LoadPicture(App.Path & "\data\img\triangulo_verde.jpg")
        Comp_Test10(1).Visible = True
        Component_2Pos(1) = "triangulo_verde"

        Comp_Test10(0).Picture = LoadPicture(App.Path & "\data\img\cuadrado_rojo.jpg")
        Comp_Test10(0).Visible = True
...
Public Sub Iniciar()
    ...
    'posicionamiento areas presentación y componentes del test 8
    With AT2_I
        .Height = (Screen.Height / 2) - (Screen.Height / 8)
        .Width = AT2_I.Height
        .Left = Screen.Width / 4 - AT2_I.Width / 2
    ...
    End With
    With Comp_Test8(0)
        .Top = (AT2_I.Height / 2) - (Comp_Test8(0).Height / 2)
        .Left = (AT2_I.Width / 2) - (Comp_Test8(0).Width / 2)
    End With
    With Comp_Test8(1)
        .Top = (AT2_D.Height / 2) - (Comp_Test8(1).Height / 2)
        .Left = (AT2_D.Width / 2) - (Comp_Test8(1).Width / 2)
    End With
    
     'posicionamiento areas presentación y componentes del test 9
    With AT2_I
        .Height = (Screen.Height / 2) - (Screen.Height / 8)
        .Width = AT2_I.Height
        .Left = Screen.Width / 4 - AT2_I.Width / 2
    ...
    End With
    With Comp_Test9(0)
        .Top = (AT2_I.Height / 2) - (Comp_Test9(0).Height / 2)
        .Left = (AT2_I.Width / 2) - (Comp_Test9(0).Width / 2)
    End With
    With Comp_Test9(1)
        .Top = (AT2_D.Height / 2) - (Comp_Test9(1).Height / 2)
        .Left = (AT2_D.Width / 2) - (Comp_Test9(1).Width / 2)
    End With
    
     'posicionamiento areas presentación y componentes del test 10
    With AT2_I
        .Height = (Screen.Height / 2) - (Screen.Height / 8)
        .Width = AT2_I.Height
        .Left = Screen.Width / 4 - AT2_I.Width / 2
    ...
    End With
    With Comp_Test10(0)
        .Top = (AT2_I.Height / 2) - (Comp_Test10(0).Height / 2)
        .Left = (AT2_I.Width / 2) - (Comp_Test10(0).Width / 2)
    End With
    With Comp_Test10(1)
        .Top = (AT2_D.Height / 2) - (Comp_Test10(1).Height / 2)
        .Left = (AT2_D.Width / 2) - (Comp_Test10(1).Width / 2)
    End With
